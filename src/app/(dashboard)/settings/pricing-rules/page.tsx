...
import { Save, Check, Cpu, UserCheck, Boxes, Percent } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        description="Configure machine hourly rates, labor rates, raw material $/kg catalog, and GST tax parameters for quotation calculations."
        breadcrumbs={[
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Target rates for fiber laser, press brake, and welding runtime</CardDescription>
          </CardHeader>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Setup technician and operator labor rates</CardDescription>
          </CardHeader>
          <CardContent className="space-y-3 text-xs">
            <div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Sheet metal alloy $/kg baseline cost</CardDescription>
          </CardHeader>
          <CardContent className="space-y-3 text-xs">
